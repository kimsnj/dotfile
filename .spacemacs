...
(defun dotspacemacs/layers ()
  ...
  (setq-default
   ...
   '(
     ...
     ;; Personal layer containing all my preferences
     personal
     )
...
(custom-set-faces
 ...
 '(highlight ((t (:background "#2E3441"))))
 '(org-todo ((t (:foreground "LemonChiffon3" :weight bold)))))
